...
export default function Home() {
  ...
  const rewriteRef = useRef<() => void>(() => {})

  const setRewriteHandler = useCallback((handler: () => void) => {
    rewriteRef.current = handler
  }, [])
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center mt-4 animate-in fade-in duration-1000">
      ...
      <ChatResponse setTriggerFunction={setRewriteHandler} text={text} />
    </div>
  )
}
